...
{
	print STDERR "Usage:\n";
    print STDERR "    cat <rules> | perl $0 <score-names> [<feat-name> <max-value>]+\n";
	...
	print STDERR "the feature scores from <score-names> and their corresponding maximum\n";
...
# Store hash of features to judge rules on, along with their maximum values:
my %ScoreCutoffs = ();
